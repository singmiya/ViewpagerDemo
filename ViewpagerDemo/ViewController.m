...
- (void)viewDidLoad {
    ...
    ViewpagerView *viewpager3 = [[ViewpagerView alloc] initViewpagerViewWith:CGRectMake(0, 360, SCREEN_WIDTH, 120)  dataSource:arr viewStyle:ViewpagerViewStyleDefault andBottomStyle:BottomViewStyleDefault | BottomViewStylePageControlLeft | BottomViewStylePageControlSquare | BottomViewStylePageControlFeatureScale];
