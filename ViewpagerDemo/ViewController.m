...
//    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 100, SCREEN_WIDTH, 200)];
//    imageView.image = [UIImage generateRandomColorImageWithSize:(CGSize){SCREEN_WIDTH, 200}];
...
//    viewpager.backgroundColor = [UIColor redColor];
